...
public class DispatcherConfigurationManager {
    ...
    @Getter
    private Path directoryWithOldFiles;
    @Getter
    private Path directoryWithNewFiles;
    @Getter
    private Path directoryWithFilesToDelete;
    @Getter
    private Path directoryWithFilesToUpdate;
    @Getter
    private Path directoryWithFilesToAdd;
    @Getter
    private Path logDirectory;
    @Getter
    private Boolean isConfigurationSuccessful;
